...
export default {
	...
	methods: {
        ...
        \================================================================================================*/
		async edit() {
			wwLib.wwPopups.addStory('WWDROPDOWN_EDIT', {
				title: {
					en: 'Edit dropdown menu',
				...
				storyData: {
					list: {
						WWDROPDOWN_COLOR: {
							...
							desc: {
								en: 'Edit background and hover colors',
								fr: 'Éditer la couleur du fond et du hover',
							},
							icon: 'wwi wwi-color',
							shortcut: 'c',
							next: 'WWDROP_CUSTOM',
